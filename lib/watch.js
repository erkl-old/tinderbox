...
// polls the file-system every INTERVAL milliseconds, creating a
...
Watcher.prototype.wait = function () {
  ...
  function check() {
    fs.stat(self.file, function (err, stats) {
      if (err != null) {
        self.timeout = setTimeout(check, INTERVAL)
        return
      }
...
// flags all this file's keys as modified
Watcher.prototype.trigger = function () {
  this.keys.forEach(function (key) {
    // TODO: register the key as changed
  })
}
